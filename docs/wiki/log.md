...
- [QA] 2026-06-27 — E2E (Playwright): 5 CTAs + FAB com wa.me/mensagem/_blank/noopener OK; tel/mailto OK; 5 âncoras resolvem + scroll OK; FAB e header sticky/blur OK; botão Google desabilitado; CTA hero acima da dobra (390px). 404 gerado no build (prod).
- [REDESIGN] 2026-06-27 — Aplicada skill /impeccable + referência drrodrigoandrade.com. Novo design system: paleta OKLCH teal-navy + dourado champanhe + creme (mantém marca, foge do reflexo "branco+teal"); fontes Hanken Grotesk + Spectral itálico (saíram Plus Jakarta+Inter da reflex-reject list). Hero imersivo full-bleed, navbar pílula flutuante, ícones line-art, molduras arco, blocos editoriais numerados. Removidos: gradient text (banido), eyebrows repetidos, grid de cards idênticos, hero-metric template.
- [FIX] 2026-06-27 — Bug crítico de tokens: cores definidas como oklch() completo quebravam o modificador de opacidade do Tailwind (oklch(oklch())) — texto cream/XX caía para cor herdada e ficava ilegível. Corrigido para tripletas L C H cruas + oklch(var(--x)/<alpha-value>). Validado em 390/768/1280. Build verde.
